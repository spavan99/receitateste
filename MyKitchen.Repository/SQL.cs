...
namespace MyKitchen.Repository
{
    internal class SQL
    {
        //private static readonly string _connectionString = $"Server=db.assembly.pt;Database=--;User Id=Students;Password=SkillUpForTomorrow;TrustServerCertificate=True";
        private static readonly string _connectionString = $"Server=db.assembly.pt;Database=JD_YV_mykitchen;User Id=Students;Password=SkillUpForTomorrow;TrustServerCertificate=True";
